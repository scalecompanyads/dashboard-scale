    ...
    <div className="flex flex-1 items-center justify-center p-8">
      <div className="max-w-lg rounded-card border border-status-critical/30 bg-status-critical/10 p-6 text-sm text-status-critical">
        ...
        <ol className="mt-2 list-decimal space-y-1 pl-5 text-status-critical/90">
          <li>
            Rode <code className="rounded-none bg-black/30 px-1 py-0.5">supabase/migrations/0001_init_schema.sql</code> e{" "}
            <code className="rounded-none bg-black/30 px-1 py-0.5">0002_rls_policies.sql</code> no SQL Editor do Supabase.
          </li>
          <li>
            Confirme que <code className="rounded-none bg-black/30 px-1 py-0.5">.env.local</code> tem{" "}
            <code className="rounded-none bg-black/30 px-1 py-0.5">SUPABASE_SERVICE_ROLE_KEY</code> preenchido e reinicie o
            servidor.
          </li>
        ...
        <button
          ...
          className="mt-4 rounded-none border border-status-critical/40 bg-status-critical/15 px-4 py-2 text-xs font-bold text-status-critical transition hover:bg-status-critical/25"
        >
          Tentar novamente
        </button>
      </div>
