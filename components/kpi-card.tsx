...
export function KpiCard({
  ...
  // Rótulo sempre branco: o azul da marca é escuro demais para caixa alta em
  // corpo pequeno sobre o card preto. A cor de status continua aparecendo na
  // faixa do topo, no valor e no badge do ícone — o título não precisa dela.
