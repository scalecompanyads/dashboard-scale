...
function FourthPlaceRow({ closer }: { closer: CloserStats }) {
  ...
  return (
    <div className="relative mt-3 flex items-center gap-2.5 rounded-none border border-hairline bg-white/[0.02] px-3 py-2">
      <span className="flex h-6 w-6 shrink-0 items-center justify-center rounded-none bg-white/[0.06] text-[11px] font-bold text-secondary">4º</span>
      {photo ? (
